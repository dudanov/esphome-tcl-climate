...
void TclClimate::takeControl() {
  ...
  //маска 00011000]: 			01 - качание сверху вниз, ПО УМОЛЧАНИЮ 			10 - качание в верхней половине 			11 - качание в нижней
  //половине 		Режим фиксации заслонки (режим качания заслонки роли не играет, если качание выключено) [32 байт, маска
  //00000111]: 			000 - нет фиксации, ПО УМОЛЧАНИЮ 			001 - фиксация вверху 			010 - фиксация между верхом и серединой 			011 -
  //фиксация в середине 			100 - фиксация между серединой и низом 			101 - фиксация внизу 	Горизонтальные заслонки 		Качание
  //горизонтальных заслонок [11 байт, маска 00001000]: 			0 - Качание отключено, заслонки в последней позиции или в
  //фиксации 			1 - Качание включено в выбранном режиме 		Режим качания горизонтальных заслонок (режим фиксации заслонок роли
  //не играет, если качание включено) [33 байт, маска 00111000]: 			001 - качание слева направо, ПО УМОЛЧАНИЮ 			010 - качание
  //слева 			011 - качание по середине 			100 - качание справа 		Режим фиксации горизонтальных заслонок (режим качания заслонок
  //роли не играет, если качание выключено) [33 байт, маска 00000111]: 			000 - нет фиксации, ПО УМОЛЧАНИЮ 			001 - фиксация
  //слева 			010 - фиксация между левой стороной и серединой 			011 - фиксация в середине 			100 - фиксация между серединой и
  //правой стороной 			101 - фиксация справа
...
void TclClimate::sendData(byte *message, byte size) {
  TclClimate::dataShow(1, 1);
...
String TclClimate::getHex(byte *message, byte size) {
  String raw;
...
byte TclClimate::getChecksum(const byte *message, size_t size) {
